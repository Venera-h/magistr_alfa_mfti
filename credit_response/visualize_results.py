...
axes[0, 1].boxplot(predictions, vert=False, patch_artist=True)
...
axes[1, 0].plot(sorted_pred, cumulative, linewidth=2)
...
bars = axes[1, 1].bar(thresholds, percentages, width=0.08, edgecolor='black', alpha=0.7)
